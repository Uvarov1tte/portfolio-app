...
import { Point, Mouse, Config, WavesProps } from "./types";
import { Noise } from "./classes";
...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function setLines() {
      ...
      const totalLines = Math.ceil(oWidth / xGap) / 2;
      ...
      for (let i = 0; i <= totalLines; i++) {
        const pts: Point[] = [];
        const randomVariation = Math.random() * xGap - xGap / 2;
        const ptsX = xStart + xGap * i + randomVariation;
  ...
  return (
    <div
      ...
      className={`absolute bottom-0 right-0 w-full h-full overflow-hidden ${className}`}
    >
      {/* <div
